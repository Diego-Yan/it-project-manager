<div class="space-y-5">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl border p-5">
        ...
        <div class="grid sm:grid-cols-3 gap-3">
            <input wire:model="formTitle" placeholder="工单标题*" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700 sm:col-span-3">
            <select wire:model="formType" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700"><option value="request">服务请求</option><option value="incident">故障报修</option><option value="change">变更申请</option><option value="problem">问题管理</option></select>

<div class="space-y-5">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl border p-5">
        ...
        <div class="grid sm:grid-cols-4 gap-3">
            <input wire:model="formName" placeholder="SLA 名称" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700">
            <select wire:model="formPriority" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700"><option value="low">低优先级</option><option value="medium">中优先级</option><option value="high">高优先级</option><option value="critical">紧急</option></select>
            <input type="number" wire:model="formResponse" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700" placeholder="响应时限(分钟)">
            <input type="number" wire:model="formResolution" class="px-3 py-2 text-sm border rounded-xl dark:bg-zinc-800 dark:border-zinc-700" placeholder="解决时限(分钟)">
        </div>

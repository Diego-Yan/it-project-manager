                ...
                <div class="flex items-start justify-between gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        <a href="{{ route('projects.kanban', $project) }}"
                            class="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-xl transition-colors">

    ...
    x-data="{
        ...
        init() {
            ...
            window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', () => {
                if (this.theme === 'system') this.$el.classList.toggle('dark', this.darkMode);
            });
            // Apply initial state
        ...
        themeIcon() {
            return this.darkMode
                ? 'M21.752 15.002A9.72 9.72 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 007.002-3.998z'
                : 'M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z';
        },

        themeLabel() {
            return { light: '浅色', dark: '深色', system: '跟随系统' }[this.theme] || '';
        }
    }"
    x-init="init()"
    class="h-full">
        ...
        <header class="h-16 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-4 px-4 lg:px-6 shrink-0">
            ...
            <div class="flex items-center gap-3">
                ...
                <button @click="toggleTheme()"
                    ...
                    {{-- System icon (auto/follow system) --}}

...
class Asset extends Model
{
    ...
    public function getStatusLabelAttribute(): string { return match($this->status) { 'in_use'=>__('使用中'),'available'=>__('空闲'),'repair'=>__('维修中'),'retired'=>__('已报废'), default=>$this->status }; }
    ...
    public function getCategoryLabelAttribute(): string { return match($this->category) { 'fixed'=>__('固定资产'),'non_fixed'=>__('非固定资产'),'consumable'=>__('损耗品'), default=>$this->category }; }
